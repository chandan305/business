...
import FundingDropdown from "./FundingDropdown";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <NavLink
            className="text-sm font-medium px-4 py-2 rounded-lg text-gray-500 hover:text-black hover:bg-gray-100 transition-all duration-300"
            to="/philosophy"
          >
            Philosophy
          </NavLink>
      ...
      {open && (
        <div className="md:hidden bg-white border-t px-6 pb-6 pt-4 flex flex-col gap-2">
          ...
          <NavLink
            ...
            to="/philosophy"
            className="text-base font-medium px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100"
          >
            Philosophy
          </NavLink>
          <NavLink
